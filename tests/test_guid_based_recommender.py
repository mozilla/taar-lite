...
RESULTS = {
    ...
    'rownorm_sum_tiebreak_cutoff': [('guid-1', '000000000.3333333333.0000010000'),
                                    ('guid-3', '000000000.3333333333.0000008000'),
...
@mock_s3
def test_floor_install_threshold(default_ctx, TIE_MOCK_DATA, CUTOFF_GUID_RANKING):
